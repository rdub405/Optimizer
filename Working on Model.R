...
ff.data2 <- ff.data[,c("Position", "Name", "Salary", "AvgPointsPerGame","teamAbbrev","Projected","DFPoints")]
#ff.data2 <- ff.data[,c("pos", "player", "Salary", "fpts","team","fpts","fpts")]
...
getplayers <-function(data, pos) {
  res = data[data[["Position"]] %in% pos, c("Position", "Name", "Salary", "AvgPointsPerGame","teamAbbrev","Projected","DFPoints")];
...
write.csv(LineupsTest, file = "C:/Users/williarl/Documents/RW/output/test1230.csv")
